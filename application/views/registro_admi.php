...
<html lang="en">
    ...
    <body>
        ...
        <div class="container well">
            <h2>XCode Registro de administrador</h2><br>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>index.php/ControladorAdministradores/solicitud_registro">
